...
import com.google.android.gms.auth.api.signin.GoogleSignInClient;  // Missing import
...
public class Profile extends Fragment {
    ...
    private void logoutuser() {
        ...
        new AlertDialog.Builder(getActivity()).setTitle("Log Out?").setMessage("Are you sure to logout from App?")
                        .setCancelable(false)
